...
if __name__ == '__main__':
    setuptools.setup(
        name="object-detection-tflite",
        version="0.0.1",
        url="https://github.com/Intelligence-Design/ml_function/object_detection/tflite",
        install_requires=load_requires_from_file('requirements.txt'),
        dependency_links=load_links_from_file('requirements.txt'),
        author="id",
        author_email="",
        description="ml_function/object_detection/tflite",
        long_description="ml_function/object_detection/tflite",
